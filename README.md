...
- `tmux`, `git`, `age`, `sops`
- [Claude Code](https://claude.ai/code) (installed per agent user under `~/.local/bin/claude` by `clem provision`)
...
See [docs/hetzner.md](docs/hetzner.md) for the full end-to-end walkthrough — creating the VPS, provisioning, authenticating each agent, and starting the team.
